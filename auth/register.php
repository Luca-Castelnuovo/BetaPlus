            ...
            <div class="card login">
                ...
                <div class="card-content">
                    <form action="/auth/register.php" method="post">
                        ...
                        <p>
                            <label>
                                <input name="class" type="radio" value="4havo" />
                                <span>4havo</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input name="class" type="radio" value="4vwo" />
                                <span>4vwo</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input name="class" type="radio" value="5havo" />
                                <span>5havo</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input name="class" type="radio" value="5vwo" />
                                <span>5vwo</span>
                            </label>
                        </p>
                        <p>
                            <label>
                                <input name="class" type="radio" value="6vwo" />
                                <span>6vwo</span>
                            </label>
                        </p>
                        <div class="row">
