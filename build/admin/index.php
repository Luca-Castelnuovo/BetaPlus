...
<?php footer("<script>var instance = M.Tabs.init(document.querySelector('.tabs'), {});</script><script src='{$GLOBALS['config']->cdn->js->ajax}'></script><script src='{$GLOBALS['config']->cdn->js->admin}'></script>"); ?>
