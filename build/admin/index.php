    ...
    <div class="container">
        <div class="row">
            ...
            <div id="extra" class="col s12">
                ...
                <div class="row">
                    <h3>Sessions</h3>
                    <a href="/admin/process/<?= csrf_gen() ?>/remember///" class="waves-effect waves-light btn-large color-secondary--background"><i class="material-icons left">code</i>Destroy all sessions</a>
                </div>
            </div>
        </div>
    </div>
